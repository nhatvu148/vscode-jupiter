...
Connections.CreateConnConm(strName="", iEType=0, iMethod=0, iCoordSys=0, iConmId=0, crMatCoord=None, dMass=0.0, dlX=[0, 0, 0], dlVintertia0=[0, 0, 0], dlVintertia1=[0, 0, 0])
...
Geometry.ShowAdjacent.Elements(Angle=0.0, IncludeStopElem=0, Layer=1,IsPreview=0, taStartElemCr=[] ,taStopElemCr=[])
Geometry.ShowAdjacent.Faces(Angle=0.0, IncludeStopFace=0, Layer=1,IsPreview=0, taStartFaceCr=[] ,taStopFaceCr=[])
...
MidPlaneEdit.AddItems.Face.EFProject(crlEdge=[], crlFace=[], bMergeFace=False, bMergeEdge=False, dMergeEdgeAngle=0.0, bMultiEF=False)
MidPlaneEdit.AddItems.Edge.ProjectEdgeToFace(crlEdge=[], crlFace=[], bExtendEdge=True)
MidPlaneEdit.AddItems.Face.EFExtendFreeEdge(crlEdge=[], crlFace=[], bMergeFace=False, bMergeEdge=False, bUseNeighDir=False, dMergeEdgeAngle=0.0, bMultiEF=False)
...
MidPlaneEdit.Face.FaceExtendToIntersection(crEdge0=None, crEdge1=None)
MidPlaneEdit.Manual.MidByPair(crlBaseFaces=[], crlPairFaces=[], crlRefFaces=[], crPart=None, bMergeFaces=False, bExtendFaces=False, bHideFaces=False, dExtendTol=0.0, dMergeEdgesAngle=0.0, dStitchFaces=0.0)
MMCCarACTools.ACModelCreationTools.MeshedFace(crlItem1=[], crlItem2=[], crlItem3=[], crlPart=[], iType=0, dMeshSise=0.0, bMergeTol=False, dTol=0.0, bCreatePart=False)
MidPlaneEdit.Edge.Nodes(crlNode=[])
MidPlaneEdit.Manual.vecOffset(crlFace=[], crPart=None, dOffset=0.0, bCyl=False, strNewPartName="")
MMCCarACTools.ClearanceElement.Edit(dDx=0.0, dDy=0.0, dDz=0.0, dLx=0.0, dLy=0.0, dLz=0.0, crlTarget=[], crlDestNode=[], poslDestPoint=[[]])
MufflerHA.CopyMeshCount(crlMasterEdge=[], crlSlaveEdge=[], strBaseName="")
MufflerHA.CreateEdge.PerpendicularLineToEdge(crNode=None, crEdge=None, crlFace=[], bBreakFace=False)
MufflerHA.CreateEdgeClassic.ProjectLine(ilAiedgeidForMacro=[], ilAifaceidForMacro=[], bDivideFace=False, crlAiparttargetForMarco=[])
MufflerT.SpecialModeling.Rod.Rod(crlNode=[], dRadius=0.0, iType=0, dMeshSize=0.0, dStartDist=0.0, dWeldDist=0.0, iDivNumber=0, dDeformWidth=0.0, iTransitionElem=0, dlPosDir=[])
MuxWeld.DefineSequence.Single(crEdit=None)
MuxWeld.CreateWeld.Auto(iIconnectattributeMethod=0, strStrconnectattributeName="", crlMasterTarget=[], crlSlaveTarget=[], iIconnectattributeCoordsys=0, crEdit=None)
...
MMCCarACTools.ClearanceElement.Connect(crlFace=[], crlElem=[], iConnectionMethod=0)
NSModeling.NSModeling_Close_Hole(iType=0, dMaxLength=0.0, bMergeFaces=False, bSetCenterPoint=False, crlNode=[], crlPart=[])
...
Post.ImportResults.ADVC2PostJob(strName="", strlResultFolderPaths=[], crEdit=None)
...
Properties.Cohesive(strName="", crMaterial=None, iResponse=0, bSpecifyThick=False, dInitialThick=0.0, crlTarget=[], crEdit=None, iFLG=0, iId=0, iSolverType=0, iADVCResponseType=0, iADVCStackDir=0, iEnableADVCThickness=0, dADVCThickness=DFLT_DBL)
Properties.ElemRelatedInfo.Shell(listErishellThetaProp=[], listErishellCsProp=[], listErishellZoffsProp=[])
Properties.Gasket(strName="", crMaterial=None, dThickX=0.0, dThickY=0.0, dThickZ=0.0, crlTarget=[], crEdit=None, iStData=0, iFLG=0)
...
Properties.Property1DBeamSimple(strName="", iId=0, crSection=None, crMat=None, vecOrient=[DFLT_DBL,DFLT_DBL,DFLT_DBL], crlTarget=[], crEdit=None)
...
SNOnePush.AutoSweepClosedLoopShaped(crlPart=[], dMeshSize=0.0, dLengthSize=0.0)
Properties.ThicknessDistribution(dMax=1, dMin=0, iByEach=0, dlThicknessValueSet=[])
SNOnePush.DropTest.CalcTimestep(dRelevantElemRate=0.0, dChangeMassRage=0.0)
...
StiffCalc.Force(strName="", poslForce=[[]], poslMoment=[[]], iEnArrowDir=0, iDistributionMethod=0, crCurCoord=None, crTable=None, crNodeSet=None, dFPhase=0.0, dFDelay=0.0, crPhaseTable=None, strFormula0="", strFormula1="", strFormula2="", strFormula3="", strFormula4="", strFormula5="", crlTarget=[], crEdit=None)
SZOnepushReliability.Assembly.ContactSurface(crlSrcFace=[], crlTarPart=[], dTolerance=0.0, iLayer=0)
SZOnepushReliability.AlignMidNode(crlSource=[], crlTarget=[])
SZOnepushReliability.Assembly.CreateWeld(crlWelds=[], dMeshSize=0.0, iRrate=0, dFilletRadius=0.0)
SZOnepushReliability.MeshEdit.FilletMapping(crlPart=[], crlFace=[], dMinRadius=0.0, dMaxRadius=0.0, dMinAngle=0.0, dMaxAngle=0.0, bConvex=False, bConcave=False)
...
Test.ZGeometryTest.IntersectionCheck(crlPart=[], crlFace=[], crlElem=[], iType=0)
Test.ZGeometryTest.ShellAssy(taPart=[], crlFace=[], _iMeshType=0, _bSelfIntersection=False, _iMethod=3, _dGapTol=2.1)
Tool.Connections.Contact(strName="", iContactType=1, dInterferenceClosure=0.5, dFrictionCoefficient=0, iShellOffset=0, iMasterShellOrientation=0, iSlaveShellOrientation=0, iMarkerColor=65280, bInitialAdjustment=0, crlMaster=[], crlSlave=[], crMasterGroup=None, crSlaveGroup=None, crEdit=None)
Test.FindFacesInPart(crPart=None, strIdentical="")
Tool.Connections.Mass(strName="Mass", crlTargetNodes=[], dMass=0.00, iDof=0, crEdit=None)
Tool.Connections.RBE3(iMethod=7, crlMasterTarget=[], crlSlaveTarget=[], listRbe3TermConnection=[], iTypeRBE3=3, strName="", crCoordSys=None, dTolerance=0.0, posVirtualNodePos=[0, 0, 0], iSurfaceDef=0, crEdit=None, bUpdateDispCS=True, bCornerOnly=False)
Tool.Coordinates.AttachCircle(strName="CRect1", iCoordType=0, crEdge=None, bCreateNew=True, crRefCoord=None, crEdit=None)
Tool.Coordinates.Align(strName="CRect1", iCoordType=0, iCoordAxis=0, bCreateNew=True, crlNode=[], crEdge=None, crEdit=None)
...
Tool.Coordinates.AttachNode(strName="CRect1", iCoordType=0, crNode=None, bCreateNew=True, crRefCoord=None, crEdit=None)
Tool.Coordinates.CylinderFace(strName="CRect1", iCoordType=0, crFace=None)
Tool.Coordinates.Rotate(strName="CRect1", iCoordType=0, vecRotate=[0.0,0.0,0.0], bCreateNew=True, crRefCoord=None, crEdit=None)
Tool.Coordinates.ThreeNode(strName="CRect1", iCoordType=0, iOrder=0, crlNode=[], veclPoints=[], crRefCoord=None, crEdit=None)
Tool.Coordinates.Face(strName="CRect1", iCoordType=0, iOrder=0, veclPoint=[], crlNode=[], crItem=None, crRefCoord=None, crEdit=None)
Tool.Coordinates.vecOffset(strName="CRect1", iCoordType=0, vTranslate=[0.0,0.0,0.0], bCreateNew=True, crRefCoord=None, crEdit=None)
Tool.ElementCS(iMethod=0, iDispType=0, bDispXDir=False, bDispCoord=False, dDispScale=1, crlTarget=[])
Tool.Group.CreateGroup(strGroupName="", crlTarget=[], crEdit=None)
Tool.Group.DeleteGroupEntity(crlDelGroup=[])
Tool.ImprintEdges.ClosedLine(veclPositions=[[]], crlTargetFace=[], iEnableBreakFace=0)
Tool.ImprintEdges.ClosedLine2(poslPoint=[[]], bDivide=False, crlPart=[])
Tool.ImprintEdges.Line(veclAvPoint=[[]], bDivideFace=True, crlPart=[])
Tool.Measure.Angle.By2Axis(xyz1=[0, 0, 0], xyz2=[0, 0, 0], target="Angle", Precision=6)
Tool.Measure.Angle.ProjectedNode(crNode=None, strTarget="All", iPrecision=6)
Tool.Measure.Angle.TwoNodesAxis(crNode1=None, crNode2=None, dlAxis=[], strTarget="", iPrecision=0)
Tool.Measure.Distance.Edge(crEdge=None, iOption=0, iPrecision=6)
Tool.Measure.Distance.EdgeNode(crPoint=None, crEdge=None, iOption=0, iPrecision=6)
Tool.Measure.Distance.FaceNode(crlFace=[], crlNode=[], iPrecision=0)
Tool.Measure.Distance.LineNode(crlTargetNode=[], iPrecision=6)
Tool.Measure.Distance.Plane3NodesToNode(crNode1_4=None, crNode2_4=None, crNode3_4=None, crNode4_4=None, iPrecision=6)
Tool.Measure.Distance.PlaneElemToNode(crNode=None, crElem=None, iPrecision=6)
Tool.Measure.Distance.TwoEdges(crEdge1=None, crEdge2=None, iOptions=0, iPrecision=0)
Tool.Measure.Distance.TwoNodes(crNode1=None, crNode2=None, iPrecision=0)
Tool.Measure.Distance.TwoPoints(posPoint1=[0,0,0], posPoint2=[0,0,0], iPrecision=6)
Tool.Measure.Mass.ByMaterial(crlPart=[], strDensity="", strTarget="", iPrecision=0)
Tool.Measure.Radius.ByThreeNodes(crNode1_3=None, crNode2_3=None, crNode3_3=None, iPrecision=0)
Tool.Measure.Radius.MeasureRadiusBy3Nodes(crNode1_3=None, crNode2_3=None, crNode3_3=None, iPrecision=0)
Tool.Measure.Volume(crlPart=[], iPrecision=6)
Tool.MeshQuality.Manual.CleaningVolumeMesh(crlPart=[], crlElem=[], dLimitVolume=0.0, iMode=0)
Tool.MeshQuality.Manual.CleanTetCollapse(crlElem=[], iKeep=0, iCheckCondition=0, dLimitValue=0.0, iCleanupMode=0)
...
Tools.GroupByDCS()
Tools.Measure.Angle.ProjectedNode(crNode=None, strTarget="All", iPrecision=6)
Tools.Measure.Angle.TwoAxis(dlXyz1=[0, 0, 0], dlXyz2=[0, 0, 0], strTarget="Angle", iPrecision=6)
Tools.Measure.Angle.TwoEdges(crEdge1=None, crEdge2=None, strTarget="Angle", iPrecision=6)
Tools.Measure.Angle.TwoElemEdges(crpElemEdge1=[], crpElemEdge2=[], strTarget="Angle", iPrecision=6)
Tools.Measure.Area.Body(crlPart = [], iPrecision = 6)
Tools.Measure.Angle.TwoNodesAxis(crNode1=None, crNode2=None, dlAxis=[1,0,0], strTarget="Angle", iPrecision=6)
Tools.Measure.Area.Face(crlFace = [], iPrecision = 6)
Tools.Measure.Angle.ThreeNodes(crNode1=None, crNode2=None, crNode3=None, strTarget="All", iPrecision=6)
Tools.Measure.Distance.EdgeNode(crEdge=None, crNode=None, iPrecision=6)
Tools.Measure.Area.Element(crlElem = [], iPrecision = 6)
Tools.Measure.Distance.FaceNode(crlFace=[], crlNode=[], iPrecision=6)
Tools.Measure.Distance.Plane3NodesToNode(crNode1_4=None, crNode2_4=None, crNode3_4=None, crNode4_4=None, iPrecision=6)
...
Tools.Measure.Distance.TwoEdges(crEdge1=None, crEdge2=None, iPrecision=6)
...
Tools.Measure.Radius.Edge(crEdge=None, iPrecision=6)
Tools.Measure.Distance.LineNode(crlTargetNode=[], iPrecision=6)
Tools.NodeCS(crlInst=[], crCoordSystem=None)
Tools.ModelInfo(strPath="", Name="",  listMeshPartInfoTool=[], bPropertyAssignedPart=False, bPropertyAssignedSummary=False, iModelNode=0, iNmodelnodeWithprop=0, ilModelElement=[], ilNmodelelemWithprop=[], ilModelLBC=[], iModelContact=0, ilModelConnection=[], ilModelProperty=[])
Tools.NodeCSGroup()
...
Tools.Measure.Radius.ThreeNodes(crNode13=None, crNode23=None, crNode33=None, iPrecision=6)
Tools.RenumberByFile(strCSVPath="", iConfilctStrategy=0, bNeedToUpdateCount=False)
Tools.Section(bSection=False)
