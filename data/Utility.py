...
class RightClick:
    ...
    def AddToReference(self, crSrcPart=None, crDestPart=None):
...
class HeatFlux:
    ...
    def SurfaceFlux(self, strName="", dFflux=0.0, iDistributionMethod=0, crTable=None, crlTarget=[], crEdit=None):
...
class MSCNastran:
    ...
    def ManualGroup(self, strName="", tssolverContact=NASTRAN_CONTACT(), crplTarget=[], crEdit=None, iColor=65280, iMethod=1):
...
class RigidElements:
    ...
    def RBE2General(self, iMethod=0, crlMasterTarget=[], crlSlaveTarget=[], iEType=2, strName="RBE2_1", crCoordSys=None, dTolerance=0.0, iUlDOFs=63, dlVirtualNodePos=[0, 0, 0], iSurfaceDef=0, crEdit=None, iEnableUpdateDispCS=1, iEnableCornerOnly=0, iDuplicateMode=-1):
...
class BodyCut:
    ...
    def XXYYOnOnePoint(self, crPart=None, posCutPos=[0,0,0], iType=0, dOffset=0.0, bSplit=False, bSectionFace=True, bShateFace=False, crLocalCoor=None):
...
class Edge:
    ...
    def NodeShortestPath(self, crFirstNode=None, crSecondNode=None, iEnableBreakFace=1):
...
class RightClick:
    ...
    def Rename(self, strNewName="", crItem=None):
...
class Sweep:
    ...
    def FaceToFace(self, crSrcFace=None, crDstFace=None, bDeleteOriginalParts=True):
...
class CreateNode:
    ...
    def CircleCenter(self, crlEdge=[], iNodeID=0, bImprint=False, crFace=None):
...
class MoveNode:
    ...
    def MoveNodeOffset(self, dDeltaX=0.0, dDeltaY=0.0, dDeltaZ=0.0, crlNode=[], crCoord=None):
...
class LocalSettings:
    ...
    def Edge(self, strName="", localMesh, crlTarget=[], ilHardPointId=[], veclHardPointXYZ=[], crlHardPointTarget=[], crEditTarget=None):
        message = "Meshing.LocalSettings.Edge('{}',{},{},{},{},{})".format(strName, crlTarget, ilHardPointId, veclHardPointXYZ, crlHardPointTarget, crEditTarget)
        return JPT_RUN_LINE(message)

    def FaceElement(self, strName="", localMesh, crlTarget=[], ilHardPointId=[], veclHardPointXYZ=[], crlHardPointTarget=[], crEditTarget=None):
        message = "Meshing.LocalSettings.FaceElement('{}',{},{},{},{},{})".format(strName, crlTarget, ilHardPointId, veclHardPointXYZ, crlHardPointTarget, crEditTarget)
        return JPT_RUN_LINE(message)

    def Model(self, strName="", localMesh, crlTarget=[], ilHardPointId=[], veclHardPointXYZ=[], crlHardPointTarget=[], crEditTarget=None):
        message = "Meshing.LocalSettings.Model('{}',{},{},{},{},{})".format(strName, crlTarget, ilHardPointId, veclHardPointXYZ, crlHardPointTarget, crEditTarget)
        return JPT_RUN_LINE(message)

    def Points(self, strName="", localMesh, crlTarget=[], ilHardPointId=[], veclHardPointXYZ=[], crlHardPointTarget=[], crEditTarget=None):
        message = "Meshing.LocalSettings.Points('{}',{},{},{},{},{})".format(strName, crlTarget, ilHardPointId, veclHardPointXYZ, crlHardPointTarget, crEditTarget)
        return JPT_RUN_LINE(message)
...
class Face:
    ...
    def EFExtendFreeEdge(self, crlEdge=[], crlFace=[], bMergeFace=False, bMergeEdge=False, bUseNeighDir=False, dMergeEdgeAngle=0.0, bMultiEF=False):
...
class Face:
    ...
    def FaceExtendtoFace(self, crlExtFaces=[], crlRefFaces=[], bMergeFace=False, bMergeEdge=False, dMergeEdgeAngle=0.0):
        message = "MidPlaneEdit.Face.FaceExtendtoFace({},{},{},{},{})".format(crlExtFaces, crlRefFaces, bMergeFace, bMergeEdge, dMergeEdgeAngle)
        return JPT_RUN_LINE(message)

    def FaceExtendToIntersection(self, crEdge0=None, crEdge1=None):
...
class Manual:
    ...
    def vecOffset(self, crlFace=[], crPart=None, dOffset=0.0, bCyl=False, strNewPartName=""):
...
class ClearanceElement:
    ...
    def Connect(self, crlFace=[], crlElem=[], iConnectionMethod=0):
...
class ImportResults:
    ...
    def ADVC2PostJob(self, strName="", strlResultFolderPaths=[], crEdit=None):
...
class Assembly:
    ...
    def CreateWeld(self, crlWelds=[], dMeshSize=0.0, iRrate=0, dFilletRadius=0.0):
...
class Angle:
    ...
    def TwoNodesAxis(self, crNode1=None, crNode2=None, dlAxis=[], strTarget="", iPrecision=0):
...
class Distance:
    ...
    def EdgeNode(self, crPoint=None, crEdge=None, iOption=0, iPrecision=6):
        message = "Tool.Measure.Distance.EdgeNode({},{},{},{})".format(crPoint, crEdge, iOption, iPrecision)
        return JPT_RUN_LINE(message)

    def FaceNode(self, crlFace=[], crlNode=[], iPrecision=0):
    ...
    def Plane3NodesToNode(self, crNode=None, crNode=None1, crNode=None2, crNode=None3, iPrecision=6):
        message = "Tool.Measure.Distance.Plane3NodesToNode({},{},{},{},{})".format(crNode, crNode, crNode, crNode, iPrecision)
        return JPT_RUN_LINE(message)
    ...
    def TwoEdges(self, crEdge1=None, crEdge2=None, iOptions=0, iPrecision=0):
        message = "Tool.Measure.Distance.TwoEdges({},{},{},{})".format(crEdge1, crEdge2, iOptions, iPrecision)
        return JPT_RUN_LINE(message)

    def TwoNodes(self, crNode1=None, crNode2=None, iPrecision=0):
        message = "Tool.Measure.Distance.TwoNodes({},{},{})".format(crNode1, crNode2, iPrecision)
        return JPT_RUN_LINE(message)

    def TwoPoints(self, posPoint1=[0,0,0], posPoint2=[0,0,0], iPrecision=6):
...
class Radius:
    ...
    def MeasureRadiusBy3Nodes(self, crNode1_3=None, crNode2_3=None, crNode3_3=None, iPrecision=0):
...
class Manual:
    ...
    def CleanTetCollapse(self, crlElem=[], iKeep=0, iCheckCondition=0, dLimitValue=0.0, iCleanupMode=0):
...
class Connections:
    ...
    def Mass(self, strName="Mass", crlTargetNodes=[], dMass=0.00, iDof=0, crEdit=None):
        message = "Tool.Connections.Mass('{}',{},{},{},{})".format(strName, crlTargetNodes, dMass, iDof, crEdit)
        return JPT_RUN_LINE(message)

    def RBE3(self, iMethod=7, crlMasterTarget=[], crlSlaveTarget=[], listRbe3TermConnection=[], iTypeRBE3=3, strName="", crCoordSys=None, dTolerance=0.0, posVirtualNodePos=[0, 0, 0], iSurfaceDef=0, crEdit=None, bUpdateDispCS=True, bCornerOnly=False):
        message = "Tool.Connections.RBE3({},{},{},{},{},'{}',{},{},{},{},{},{},{})".format(iMethod, crlMasterTarget, crlSlaveTarget, listRbe3TermConnection, iTypeRBE3, strName, crCoordSys, dTolerance, posVirtualNodePos, iSurfaceDef, crEdit, bUpdateDispCS, bCornerOnly)
        return JPT_RUN_LINE(message)

    def Spring(self, iMethod=0, strName="SPRING", crlMasterTarget=[], crlSlaveTarget=[], crCoordSys=None, iSpringType=0, iGround=0, dTolerance=0.0, iDirection=0, iDistributeMode=0, iDof1=0, iDof2=0, dDampCoef=DFLT_DBL, dStressCoef=DFLT_DBL, posTStiffness=[0,0,0], posRStiffness=[0,0,0], bUpdateDispCS=True, crEdit=None):
...
class Coordinates:
    ...
    def Align(self, strName="CRect1", iCoordType=0, iCoordAxis=0, bCreateNew=True, crlNode=[], crEdge=None, crEdit=None):
        message = "Tool.Coordinates.Align('{}',{},{},{},{},{},{})".format(strName, iCoordType, iCoordAxis, bCreateNew, crlNode, crEdge, crEdit)
        return JPT_RUN_LINE(message)
    ...
    def ThreeNode(self, strName="CRect1", iCoordType=0, iOrder=0, crlNode=[], veclPoints=[], crRefCoord=None, crEdit=None):
        message = "Tool.Coordinates.ThreeNode('{}',{},{},{},{},{},{})".format(strName, iCoordType, iOrder, crlNode, veclPoints, crRefCoord, crEdit)
        return JPT_RUN_LINE(message)

    def Face(self, strName="CRect1", iCoordType=0, iOrder=0, veclPoint=[], crlNode=[], crItem=None, crRefCoord=None, crEdit=None):
        message = "Tool.Coordinates.Face('{}',{},{},{},{},{},{},{})".format(strName, iCoordType, iOrder, veclPoint, crlNode, crItem, crRefCoord, crEdit)
        return JPT_RUN_LINE(message)
...
class ImprintEdges:
    ...
    def ClosedLine2(self, poslPoint=[[]], bDivide=False, crlPart=[]):
        message = "Tool.ImprintEdges.ClosedLine2({},{},{})".format(poslPoint, bDivide, crlPart)
        return JPT_RUN_LINE(message)

    def Line(self, veclAvPoint=[[]], bDivideFace=True, crlPart=[]):
...
class Angle:
    ...
    def TwoEdges(self, crEdge1=None, crEdge2=None, strTarget="Angle", iPrecision=6):
    ...
    def TwoNodesAxis(self, crNode1=None, crNode2=None, dlAxis=[1,0,0], strTarget="Angle", iPrecision=6):
        message = "Tools.Measure.Angle.TwoNodesAxis({},{},{},'{}',{})".format(crNode1, crNode2, dlAxis, strTarget, iPrecision)
        return JPT_RUN_LINE(message)

    def ThreeNodes(self, crNode1=None, crNode2=None, crNode3=None, strTarget="All", iPrecision=6):
...
class Distance:
    ...
    def Plane3NodesToNode(self, crNode=None1=None, crNode=None2=None, crNode=None3=None, crNode=None, iPrecision=6):
        message = "Tools.Measure.Distance.Plane3NodesToNode({},{},{},{},{})".format(crNode, crNode, crNode, crNode, iPrecision)
        return JPT_RUN_LINE(message)
    ...
    def TwoEdges(self, crEdge1=None, crEdge2=None, iPrecision=6):
...
class Radius:
    ...
    def ThreeNodes(self, crNode13=None, crNode23=None, crNode33=None, iPrecision=6):
...
class Assemble:
    ...
    def AssembleFace(crlPart=[], crlFace=[], dTolerance=0.0, iFitEdge=0, iMeshSetting=0):
    ...
    def FullLayer(crPart=None, dLayerWidth=1.0, iLayer=1, bUsePyramid=False):
...
class BoundaryConditions:
    ...
    def LbcContactConvert(iConvertTo=0, iTieConvType=0, crlTarget=[]):
...
class Connections:
    ...
    def CreateConnConm(strName="", iEType=0, iMethod=0, iCoordSys=0, iConmId=0, crMatCoord=None, dMass=0.0, dlX=[0, 0, 0], dlVintertia0=[0, 0, 0], dlVintertia1=[0, 0, 0]):
...
class Designer:
    ...
    def Material(strMatName="", strPropName="", dThickness=0.0, crlTarget=[]):
...
class FileMenu:
    ...
    def LoadDB(strPath="", bUseTmpTable=False):
...
class HexModeling:
    ...
    def BoxMesh(ilPartIds=[], dMeshSize=0.0, strMaterialName=""):
    ...
    def FaceToFace(crSrcFace=None, crDstFace=None, bDeleteOriginalParts=True):
...
class Home:
    def Export(strFileName="", crlPart=[], bBigID=False, bUseUnit=True, bVert=True, bEdge=True, bFace=True, bSolid=True):
        message = "Home.Export('{}',{},{},{},{},{},{},{})".format(strFileName, crlPart, bBigID, bUseUnit, bVert, bEdge, bFace, bSolid)
        return JPT_RUN_LINE(message)
...
class ImportCAD:
    def Elysium(strlPath=[], cadElysiumParamData=CAD_ELYSIUM_PARAM_DATA(), bFaceColor=True):
        message = "ImportCAD.Elysium('{}',{},{})".format(strlPath, cadElysiumParamData, bFaceColor)
        return JPT_RUN_LINE(message)

    def CreoDirect(vecPath=[], cadProeParamData=CAD_PROE_PARAM_DATA()):
        message = "ImportCAD.CreoDirect({},{})".format(vecPath, cadProeParamData)
        return JPT_RUN_LINE(message)

    def Spatial(strlPath=[], cadSpatialParamData=CAD_SPATIAL_PARAM_DATA(), bIsNXDirect=False, bSetFaceColor=False, strCsvFilePath=""):
        message = "ImportCAD.Spatial('{}',{},{},{},'{}')".format(strlPath, cadSpatialParamData, bIsNXDirect, bSetFaceColor, strCsvFilePath)
        return JPT_RUN_LINE(message)

    def TechnoStarGeometry(strlPath=[], bUseUnit=True):
        message = "ImportCAD.TechnoStarGeometry('{}',{})".format(strlPath, bUseUnit)
        return JPT_RUN_LINE(message)

class ImportMesh:
    def AbaqusINP(strlFilePaths=[], dFaceAngle=60.0, dEdgeAngle=60.0, iImportType=1):
        message = "ImportMesh.AbaqusINP('{}',{},{},{})".format(strlFilePaths, dFaceAngle, dEdgeAngle, iImportType)
        return JPT_RUN_LINE(message)

    def AnsysDat(strlPath=[], dFaceAngle=60.0, dEdgeAngle=60.0):
        message = "ImportMesh.AnsysDat('{}',{},{})".format(strlPath, dFaceAngle, dEdgeAngle)
        return JPT_RUN_LINE(message)

    def ADVCADX(strPath="", dFaceAngle=60.0, dEdgeAngle=60.0):
    ...
    def LSDYNA(strlPath=[], dFaceAngle=60.0, dEdgeAngle=60.0):
    ...
    def NastranBdf(strlFilePaths=[], iImportType=2, dFaceAngle=60.0, dEdgeAngle=60.0, bReadNameComment=False, iCreateDup1DElemAnswer=0):
        message = "ImportMesh.NastranBdf('{}',{},{},{},{},{})".format(strlFilePaths, iImportType, dFaceAngle, dEdgeAngle, bReadNameComment, iCreateDup1DElemAnswer)
        return JPT_RUN_LINE(message)
...
class MeshEdit:
    ...
    def Face(crlFace=[], crlFace=[]Fixed, iOffsetType=0, crCoord=None, dlOffset=[1.0, 0.0, 0.0], dOffset=0, iDistType=0, dDistStrong=10, dDistWeak=20, iNodeIdPick=-1, dlPickForMacro=[]):
        message = "MeshEdit.Face({},{},{},{},{},{},{},{},{},{},{})".format(crlFace, crlFace, iOffsetType, crCoord, dlOffset, dOffset, iDistType, dDistStrong, dDistWeak, iNodeIdPick, dlPickForMacro)
        return JPT_RUN_LINE(message)
    ...
    def RefineQuality(iMetric=0, crlFace=[], crlElem=[], crlNode=[]):
...
class NSModeling:
    def NSModeling_Close_Hole(iType=0, dMaxLength=0.0, bMergeFaces=False, bSetCenterPoint=False, crlNode=[], crlPart=[]):
...
class Properties:
    ...
    def Cohesive(strName="", crMaterial=None, iResponse=0, bSpecifyThick=False, dInitialThick=0.0, crlTarget=[], crEdit=None, iFLG=0, iId=0, iSolverType=0, iADVCResponseType=0, iADVCStackDir=0, iEnableADVCThickness=0, dADVCThickness=DFLT_DBL):
    ...
    def Gasket(strName="", crMaterial=None, dThickX=0.0, dThickY=0.0, dThickZ=0.0, crlTarget=[], crEdit=None, iStData=0, iFLG=0):
        message = "Properties.Gasket('{}',{},{},{},{},{},{},{},{})".format(strName, crMaterial, dThickX, dThickY, dThickZ, crlTarget, crEdit, iStData, iFLG)
        return JPT_RUN_LINE(message)

    def Property1DBeamSimple(strName="", iId=0, crSection=None, crMat=None, vecOrient=[DFLT_DBL,DFLT_DBL,DFLT_DBL], crlTarget=[], crEdit=None):
...
class SNOnePush:
    ...
    def CADImport(dDsurfaceplaneTolerance=0.0, dDsurfaceplaneAngle=0.0, dMaxFacetWidth=0.0, bBnxMultipart=False, dChordHeightTolerance=0.0, dAngleToleranceDegree=0.0, iConvertIsolatedCurve=0, iIigesFixedcurevepreference=0, iIigesAutostitch=0, dDigesStitchtolerance=0.0, iIcatiaConvertnotshowedelement=0, iIcatiaConvertnotshowedinstance=0, iIcatiaConvertaxis=0, iIstepCreateseam=0, dDstepPointtolerance=0.0, iIacisHealacisbeforeversion=0, iIjtConvertgeometrytype=0, iIjtConvertgeneralpart=0, iIjtConvertaxis=0, iIjtConvertcenterline=0, dDcreoChordheighttolerance=0.0, dDcreoAngletolerancedegree=0.0, strAbsCreoPath="", iTransType=0, iFileType=0, strFilePath="", bRenameDuplicateName=False, strCSVFilePath=""):
...
class Test:
    ...
    def FindFacesInPart(crPart=None, strIdentical=""):
...
class Tools:
    ...
    def ModelInfo(strPath="", strPath=""Name="", listMeshPartInfoTool=[], bPropertyAssignedPart=False, bPropertyAssignedSummary=False, iModelNode=0, iNmodelnodeWithprop=0, ilModelElement=[], ilNmodelelemWithprop=[], ilModelLBC=[], iModelContact=0, ilModelConnection=[], ilModelProperty=[]):
        message = "Tools.ModelInfo('{}','{}',{},{},{},{},{},{},{},{},{},{},{})".format(strPath, strPath, listMeshPartInfoTool, bPropertyAssignedPart, bPropertyAssignedSummary, iModelNode, iNmodelnodeWithprop, ilModelElement, ilNmodelelemWithprop, ilModelLBC, iModelContact, ilModelConnection, ilModelProperty)
        return JPT_RUN_LINE(message)
...
class Utility:
    ...
    def MeasureDistanceBy2Edges(crEdgeFirst=None, crEdgeLast=None, iPrecision=6):
