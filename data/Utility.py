...
class Analysis_Permas:
    def Job(self, strName="", strDescription="", iType=0, crEdit=None, crlTarget=[], bElStress=False, bElStrain=False, bNodeStess=False, bGZip=False, bIdeas=False, bNLResult=False, iNLStepType=0, dEquiStart=0.0, dEquiStep=0.0, dEquiEnd=0.0, strNLStepList="", bTimeStep=False, iTimeStepKind=0, dTimeStart=0.0, dTimeStep=0.0, dTimeEnd=0.0, iLCId=0):
        message = "Analysis.Permas.Job('{}','{}',{},{},{},{},{},{},{},{},{},{},{},{},{},'{}',{},{},{},{},{},{})".format(strName, strDescription, iType, crEdit, crlTarget, bElStress, bElStrain, bNodeStess, bGZip, bIdeas, bNLResult, iNLStepType, dEquiStart, dEquiStep, dEquiEnd, strNLStepList, bTimeStep, iTimeStepKind, dTimeStart, dTimeStep, dTimeEnd, iLCId)
        return JPT_RUN_LINE(message)
...
class Measure_Distance:
    ...
    def Plane3NodesToNode(self, crNode1_4=None, crNode2_4=None, crNode3_4=None, crNode4_4=None, iPrecision=6):
        message = "Tool.Measure.Distance.Plane3NodesToNode({},{},{},{},{})".format(crNode1_4, crNode2_4, crNode3_4, crNode4_4, iPrecision)
        return JPT_RUN_LINE(message)
...
class Measure_Distance:
    ...
    def Plane3NodesToNode(self, crNode1_4=None, crNode2_4=None, crNode3_4=None, crNode4_4=None, iPrecision=6):
        message = "Tools.Measure.Distance.Plane3NodesToNode({},{},{},{},{})".format(crNode1_4, crNode2_4, crNode3_4, crNode4_4, iPrecision)
        return JPT_RUN_LINE(message)
...
class Tools:
    ...
    def ModelInfo(strPath="", Name="",  listMeshPartInfoTool=[], bPropertyAssignedPart=False, bPropertyAssignedSummary=False, iModelNode=0, iNmodelnodeWithprop=0, ilModelElement=[], ilNmodelelemWithprop=[], ilModelLBC=[], iModelContact=0, ilModelConnection=[], ilModelProperty=[]):
        message = "Tools.ModelInfo('{}',{},{},{},{},{},{},{},{},{},{},{},{})".format(strPath, Name,  listMeshPartInfoTool, bPropertyAssignedPart, bPropertyAssignedSummary, iModelNode, iNmodelnodeWithprop, ilModelElement, ilNmodelelemWithprop, ilModelLBC, iModelContact, ilModelConnection, ilModelProperty)
        return JPT_RUN_LINE(message)
