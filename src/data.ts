...
export const callTips = {
  ...
  "Analysis.Analysis.AbaqusStaticRiskStep": {
  ...
  "Assembly.RightClick.Rename": {
    prefix: "Rename",
    text:
      "*Name:* Assembly.RightClick.Rename  \n*Desc:* Rename item  \n *JVer:* 5.0  \n *Arg1:* strNewName (string)  \n *Arg2:* crItem (cursor)  \n *Return:* 1 success, 0 fail (int)  \n ",
  },
  ...
  "BoundaryConditions.HeatFlux.SurfaceMapping": {
    prefix: "SurfaceMapping",
    text:
      "*Name:* BoundaryConditions.HeatFlux.SurfaceMapping  \n*Desc:* Create mapping heat flux  \n *JVer:* 5.0  \n *Arg1:* strName (string)  \n *Arg2:* crlTarget (cursor list)  \n *Arg3:* iMAPPos (integer)  \n *Arg4:* iViewCp (integer)  \n *Arg5:* iCp (integer)  \n *Arg6:* iSrcType (integer)  \n *Arg7:* iMappedCpIndexArr0 (integer)  \n ... please read PSJ Command document for other args ...  \n *Return:* 1 success, 0 fail (int)  \n ",
  },
  ...
  "Connections.BoltConnections.Edge.TypeA": {
    prefix: "TypeA",
    text:
      "*Name:* Connections.BoltConnections.Edge.TypeA  \n*Desc:* Create Lbc TypeA Bolt Edge method  \n *JVer:* 5.0  \n *Arg1:* crlEdgeCur1 (cursor list)  \n *Arg2:* crlEdgeCur2 (cursor list)  \n *Arg3:* strRbeName (string)  \n *Arg4:* strBarName (string)  \n *Arg5:* iShaftType (integer)  \n *Arg6:* crCurBarProperty (cursor)  \n *Arg7:* dPlaneTol (double)  \n ... please read PSJ Command document for other args ...  \n *Return:* 1 success, 0 fail (int)  \n ",
  },
  ...
  "Connections.Gaps.TwoNodes": {
    prefix: "TwoNodes",
    text:
      "*Name:* Connections.Gaps.TwoNodes  \n*Desc:* create gap connection  \n *JVer:* 5.0  \n *Arg1:* crlMaster (cursor list)  \n *Arg2:* crlSlave (cursor list)  \n *Arg3:* iMethod (integer)  \n *Arg4:* iOriMode (integer)  \n *Arg5:* crCoord (cursor)  \n *Arg6:* strName (string)  \n *Arg7:* dU0 (double)  \n ... please read PSJ Command document for other args ...  \n *Return:* 1 success, 0 fail (int)  \n ",
  },
  "Connections.Gaps.TwoEdges": {
    prefix: "TwoEdges",
    text:
      "*Name:* Connections.Gaps.TwoEdges  \n*Desc:* create gap connection  \n *JVer:* 5.0  \n *Arg1:* crlMaster (cursor list)  \n *Arg2:* crlSlave (cursor list)  \n *Arg3:* iMethod (integer)  \n *Arg4:* iOriMode (integer)  \n *Arg5:* crCoord (cursor)  \n *Arg6:* strName (string)  \n *Arg7:* dU0 (double)  \n ... please read PSJ Command document for other args ...  \n *Return:* 1 success, 0 fail (int)  \n ",
  },
  "Connections.Gaps.TwoFaces": {
    prefix: "TwoFaces",
    text:
      "*Name:* Connections.Gaps.TwoFaces  \n*Desc:* create gap connection  \n *JVer:* 5.0  \n *Arg1:* crlMaster (cursor list)  \n *Arg2:* crlSlave (cursor list)  \n *Arg3:* iMethod (integer)  \n *Arg4:* iOriMode (integer)  \n *Arg5:* crCoord (cursor)  \n *Arg6:* strName (string)  \n *Arg7:* dU0 (double)  \n ... please read PSJ Command document for other args ...  \n *Return:* 1 success, 0 fail (int)  \n ",
  },
  ...
  "Connections.RigidElements.RBE2.ToCenter": {
    prefix: "ToCenter",
    text:
      "*Name:* Connections.RigidElements.RBE2.ToCenter  \n*Desc:* create RBE2  \n *JVer:* 5.0  \n *Arg1:* iMethod (integer)  \n *Arg2:* crlMasterTarget (cursor list)  \n *Arg3:* crlSlaveTarget (cursor list)  \n *Arg4:* iEType (integer)  \n *Arg5:* strName (string)  \n *Arg6:* crCoordSys (cursor)  \n *Arg7:* dTolerance (double)  \n ... please read PSJ Command document for other args ...  \n *Return:* 1 success, 0 fail (int)  \n ",
  },
  "Connections.RigidElements.RBE2.ToCircleCenter": {
    prefix: "ToCircleCenter",
    text:
      "*Name:* Connections.RigidElements.RBE2.ToCircleCenter  \n*Desc:* create RBE2  \n *JVer:* 5.0  \n *Arg1:* iMethod (integer)  \n *Arg2:* crlMasterTarget (cursor list)  \n *Arg3:* crlSlaveTarget (cursor list)  \n *Arg4:* iEType (integer)  \n *Arg5:* strName (string)  \n *Arg6:* crCoordSys (cursor)  \n *Arg7:* dTolerance (double)  \n ... please read PSJ Command document for other args ...  \n *Return:* 1 success, 0 fail (int)  \n ",
  },
  ...
  "Connections.SpringsDampers.Bush.TwoNodes": {
    prefix: "TwoNodes",
    text:
      "*Name:* Connections.SpringsDampers.Bush.TwoNodes  \n*Desc:* Create bush connection  \n *JVer:* 5.0  \n *Arg1:* iMethod (integer)  \n *Arg2:* strName (string)  \n *Arg3:* crlMaster (cursor list)  \n *Arg4:* crlSlave (cursor list)  \n *Arg5:* crCoord (cursor)  \n *Arg6:* dTol (double)  \n *Arg7:* iGround (integer)  \n ... please read PSJ Command document for other args ...  \n *Return:* 1 success, 0 fail (int)  \n ",
  },
  ...
  "Geometry.Transform.Position": {
    prefix: "Position",
    text:
      "*Name:* Geometry.Transform.Position  \n*Desc:* transform position  \n *JVer:* 5.0  \n *Arg1:* crlPart (cursor list)  \n *Arg2:* veclPoint (vector list)  \n *Arg3:* 0.0 ([])  \n *Arg4:* 0.0 ([]]])  \n *Arg5:* bCreateNewPart (bool)  \n *Arg6:* bCopyLBC (bool)  \n *Arg7:* bCopyProperty (bool)  \n ... please read PSJ Command document for other args ...  \n *Return:* 1 success, 0 fail (int)  \n ",
  },
  ...
  "Geometry.Transform.CylinderFace": {
    prefix: "CylinderFace",
    text:
      "*Name:* Geometry.Transform.CylinderFace  \n*Desc:* transform position  \n *JVer:* 5.0  \n *Arg1:* crlPart (cursor list)  \n *Arg2:* veclPoint (vector list)  \n *Arg3:* 0.0 ([])  \n *Arg4:* 0.0 ([]]])  \n *Arg5:* bCreateNewPart (bool)  \n *Arg6:* bCopyLBC (bool)  \n *Arg7:* bCopyProperty (bool)  \n ... please read PSJ Command document for other args ...  \n *Return:* 1 success, 0 fail (int)  \n ",
  },
  "Geometry.CADTrim": {
    prefix: "CADTrim",
    text:
  ...
  "MeshCleanup.Manual3D.DeleteNode": {
    prefix: "DeleteNode",
    text:
      "*Name:* MeshCleanup.Manual3D.DeleteNode  \n*Desc:* remove node for solid element.  \n *JVer:* 5.0  \n *Arg1:* crlNode (cursor list)  \n *Return:* 1 success, 0 fail (int)  \n ",
  },
  ...
  "Tool.Measure.Radius.ByThreeNodes": {
    prefix: "ByThreeNodes",
    text:
  ...
  "Tool.Measure.Volume": {
    prefix: "Volume",
    text:
      "*Name:* Tool.Measure.Volume  \n*Desc:* Command use for Tool Measure Volume  \n *JVer:* 5.0  \n *Arg1:* crlPart (cursor list)  \n *Arg2:* iPrecision (integer)  \n *Return:* 1 success, 0 fail (int)  \n ",
  },
  "Tool.MeshQuality.Manual.CleanTetCollapse": {
    prefix: "CleanTetCollapse",
    text:
  ...
  "Tool.MeshQuality.Manual.CleaningVolumeMesh": {
  ...
  "Tools.Measure.Angle.ThreeNodes": {
    prefix: "ThreeNodes",
    text:
      "*Name:* Tools.Measure.Angle.ThreeNodes  \n*Desc:*   \n *JVer:* 5.0  \n *Arg1:* crNode1 (cursor)  \n *Arg2:* crNode2 (cursor)  \n *Arg3:* crNode3 (cursor)  \n *Arg4:* strTarget (string)  \n *Arg5:* iPrecision (integer)  \n *Return:* 1 success, 0 fail (int)  \n ",
  },
  ...
  "Tools.Measure.Distance.Edge": {
    prefix: "Edge",
    text:
      "*Name:* Tools.Measure.Distance.Edge  \n*Desc:* Measure Edge Length  \n *JVer:* 5.0  \n *Arg1:* crEdge (cursor)  \n *Arg2:* iPrecision (integer)  \n *Return:* 1 success, 0 fail (int)  \n ",
  },
